...
extension Key {
    class func fetchLabsKeys() -> [Key] {
        ...
        let blueKC = Key(name: "Lab. Blue keycard", image: "BlueKCicon", keyDescription: "Room access keycard.", keyOpens: "Laboratory quarantine zone (G11) on the first level in The Lab.", keyFound: "WOODS\n-On Shturman's body\nRESERVE\n-On Gluhar's body\nSHORELINE\n-Inside the passenger door of the ambulance that is parked in front of the resort\n-West Wing Office 104 in the resort: On a desk\n-West Wing Office 112 in the resort: On a lowboard\nPockets and bags of Scavs", keyLoot: "Loose Medical loot\nTwo Medcase\nPossible LEDX Skin Transilluminator spawn on shelves", keyQuest: "NONE", keyComments: "Only 2 can be held in your PMC inventory at one time")
        ...
        let violetKC = Key(name: "Lab. Violet keycard", image: "VioletKCicon", keyDescription: "Room access keycard.", keyOpens: "Laboratory security post (R23) on the second level in The Lab.", keyFound: "WOODS\n-In the trunk of the black SUV that is parked in front of the blue warehouse in the lumber camp\n-In a brick house north of the lumber camp on the table next to the opened book\n-Inside the driver side door of the SUV at the checkpoint eastern of the lumber camp\nPockets and bags of Scavs\nIn spawned containers like MBSS, Documents case, Empty Wallet, ect. (Marked Circle for example)", keyLoot: "Possible Military COFDM wireless Signal Transmitter and VPX Flash Storage Module on the server rack\nWeapon mods on the shelves in the corners\nTwo Weapon boxes (5x5)\nONE Weapon box (4x4)\nMoney on the Desk\nPossible MP5SD on the server rack\nPossible modded M4A1 on the ground next to the server rack\nMultiple rare item spawns on the shelf next to the door", keyQuest: "NONE", keyComments: "Only 2 can be held in your PMC inventory at one time")
        
        let yellowKC = Key(name: "Lab. Yellow keycard", image: "YellowKCicon", keyDescription: "Room access keycard.", keyOpens: "Parking garage alarm system control panel on the second level in The Lab", keyFound: "LABS\n-In R24 (cafeteria) on the centre window table\n-In O21 on the table in front of the managers office\n-In O11 on one of the work tables\nPockets and bags of Scavs", keyLoot: "One Weapon Safe\nOne PC block\nOne Drawer\nLoose Weapon Mods on table", keyQuest: "NONE", keyComments: "The alarm system control panel can be used to disable the announcement that plays after activating the parking extraction. Scav Raiders can still spawn.\nOnly 2 can be held in your PMC inventory at one time")
