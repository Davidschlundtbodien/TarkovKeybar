...
extension Key {
    class func fetchCustomsKeys() -> [Key] {
        ...
        let cabinKey = Key(name: "Portable cabin key", image: "CabinKeyicon", keyDescription: "A key to one of the portable on-site cabins, probably the one that is used by guards.", keyOpens: "Used on a portable door south of the storage zone on customs", keyFound: "In Jackets\nPockets and bags of Scavs", keyLoot: "- Three Jackets\n- Loose loot", keyQuest: "NONE", keyComments: "NONE")
